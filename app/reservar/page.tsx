      ...
      <div className="mx-auto grid w-full max-w-7xl items-start gap-2 sm:gap-3 lg:grid-cols-[1.06fr_0.94fr]">
        <div className="glass-panel panel-hover flex min-w-0 flex-col gap-2 rounded-2xl p-2.5 sm:p-3">
          ...
          <div className="grid w-full grid-cols-1 gap-3 sm:grid-cols-[1fr_0.9fr] sm:items-start">
            <div className="mx-auto w-full max-w-[820px] rounded-2xl border border-[#d4af37]/25 bg-[#0b0b0b]/80 p-2.5 sm:p-3 lg:max-w-[880px] xl:max-w-[940px]">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-7 gap-1.5 rounded-xl bg-[#0f0f0f] p-2 sm:gap-2.5 sm:p-3 lg:gap-2">
                  {weeks.map((week, idx) => (
        ...
        <form
          ...
          className="glass-panel panel-hover mx-auto flex w-full max-w-[520px] min-w-0 flex-col gap-2 rounded-2xl p-3"
        >
