                      ...
                      {week.map((day, dayIdx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span
                              className={`inline-flex w-full items-center justify-center rounded-md px-2 py-0.5 text-[10px] font-semibold leading-tight sm:py-1 lg:text-[11px] ${statusBadgeClasses(
                                day.status,
                              )}`}
                            >
                              {day.status === "disponible"
